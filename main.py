...
from tds import CarParkTool

__CHANNEL_USERNAME__ = "THE_DREAM_SLIDE"
__GROUP_USERNAME__   = "THE_DREAM_SLIDE_INTL"
...
def banner(console):
    ...
    brand_name = figlet_format('TDS', font='bloody')
    colors = [
    ...
    print(Colorate.Horizontal(Colors.rainbow, '      𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐌𝐄 𝐓𝐎 𝐁𝐔𝐘 𝐔𝐍𝐋𝐈𝐌𝐈𝐓𝐄𝐃 𝐁𝐀𝐋𝐀𝐍𝐂𝐄 𝐅𝐁 @ 𝐓𝐇𝐄 𝐃𝐑𝐄𝐀𝐌 𝐒𝐋𝐈𝐃𝐄')) 
...
def load_client_details():
    ...
    data = response.json()
    print(Colorate.Horizontal(Colors.rainbow, '=============[ 𝐀𝐃𝐃𝐑𝐄𝐒𝐒 ]============='))
    ...
    print(Colorate.Horizontal(Colors.rainbow, '===============[ 𝐓𝐃𝐒 𝐓𝐎𝐎𝐋 ]==============='))
